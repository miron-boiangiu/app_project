...
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 52.17  | 0.12              | 0.12         | 2178576   | 0.00           | 0.00            | apply_convolution_at_pos      |
| 21.74  | 0.17              | 0.05         | 3         | 16.67          | 30.00           | _map                         |
|  8.70  | 0.19              | 0.02         | 6535728   | 0.00           | 0.00            | _update_file_byte_contents   |
|  4.35  | 0.20              | 0.01         | 13071464  | 0.00           | 0.00            | _get_int_from_buffer         |
|  4.35  | 0.21              | 0.01         | 13071456  | 0.00           | 0.00            | _get_pixel                   |
|  4.35  | 0.22              | 0.01         | 2178576   | 0.00           | 0.00            | set_pixel_rgb                |
|  4.35  | 0.23              | 0.01         | 1         | 10.00          | 40.00           | open_bmp_image               |

- Small image, 20 layers of blur :

| % Time | Cumulative Seconds | Self Seconds | Calls     | ms/call (self) | ms/call (total) | Name                          |
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 92.34  | 2.05              | 2.05         | 43571520  | 0.00           | 0.00            | apply_convolution_at_pos      |
|  1.80  | 2.09              | 0.04         | 13071456  | 0.00           | 0.00            | _get_pixel                   |
|  1.80  | 2.13              | 0.04         | 20        | 2.00           | 104.50          | apply_convolution            |
|  1.35  | 2.16              | 0.03         | 6535728   | 0.00           | 0.00            | _update_file_byte_contents   |
|  0.90  | 2.18              | 0.02         | 2178576   | 0.00           | 0.00            | get_pixel_rgb                |
|  0.90  | 2.20              | 0.02         | 3         | 6.67           | 30.00           | _map                         |
|  0.45  | 2.21              | 0.01         | 2178576   | 0.00           | 0.00            | set_pixel_rgb                |
|  0.45  | 2.22              | 0.01         | 1         | 10.00          | 60.00           | open_bmp_image               |

- Medium image, 1 layer of blur :

| % Time | Cumulative Seconds | Self Seconds | Calls     | ms/call (self) | ms/call (total) | Name                          |
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 30.77  | 0.32              | 0.32         | 7500000   | 0.00           | 0.00            | apply_convolution_at_pos      |
| 14.42  | 0.47              | 0.15         | 45000000  | 0.00           | 0.00            | _get_pixel                   |
| 11.54  | 0.59              | 0.12         | 45000008  | 0.00           | 0.00            | _get_int_from_buffer         |
| 10.58  | 0.70              | 0.11         | 1         | 110.00         | 437.50          | save_bmp_image               |
|  8.65  | 0.79              | 0.09         | 3         | 30.00          | 145.00          | _map                         |
|  7.21  | 0.86              | 0.07         | 22500000  | 0.00           | 0.00            | _update_file_byte_contents   |
|  5.77  | 0.93              | 0.06         | 7500000   | 0.00           | 0.00            | get_pixel_rgb                |
|  4.81  | 0.97              | 0.05         | 1         | 50.00          | 262.50          | open_bmp_image               |
|  2.88  | 1.00              | 0.03         | 7500000   | 0.00           | 0.00            | set_pixel_rgb                |
|  1.92  | 1.02              | 0.02         | 1         | 20.00          | 340.00          | apply_convolution            |
|  0.96  | 1.03              | 0.01         | 2         | 5.00           | 5.00            | _get_depth                   |
|  0.48  | 1.04              | 0.01         | 2         | 2.50           | 147.50          | _populate_pixel_array        |

- Medium image, 20 layers of blur :

| % Time | Cumulative Seconds | Self Seconds | Calls     | ms/call (self) | ms/call (total) | Name                          |
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 90.50  | 7.43              | 7.43         | 150000000 | 0.00           | 0.00            | apply_convolution_at_pos      |
|  2.31  | 7.62              | 0.19         | 20        | 9.50           | 381.00          | apply_convolution            |
|  1.71  | 7.76              | 0.14         | 45000000  | 0.00           | 0.00            | _get_pixel                   |
|  1.58  | 7.89              | 0.13         | 7500000   | 0.00           | 0.00            | get_pixel_rgb                |
|  1.10  | 7.98              | 0.09         | 1         | 90.00          | 336.67          | save_bmp_image               |
|  0.97  | 8.06              | 0.08         | 45000008  | 0.00           | 0.00            | _get_int_from_buffer         |
|  0.73  | 8.12              | 0.06         | 3         | 20.00          | 103.33          | _map                         |
|  0.43  | 8.15              | 0.04         | 7500000   | 0.00           | 0.00            | set_pixel_rgb                |
|  0.37  | 8.19              | 0.03         | 22500000  | 0.00           | 0.00            | _update_file_byte_contents   |
|  0.24  | 8.21              | 0.02         | 1         | 20.00          | 253.33          | open_bmp_image               |

- Big image, 1 layer of blur:

| % Time | Cumulative Seconds | Self Seconds | Calls     | ms/call (self) | ms/call (total) | Name                          |
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 31.52  | 0.52              | 0.52         | 10000000  | 0.00           | 0.00            | apply_convolution_at_pos      |
| 13.33  | 0.74              | 0.22         | 80000000  | 0.00           | 0.00            | _get_pixel                   |
| 13.03  | 0.95              | 0.21         | 80000008  | 0.00           | 0.00            | _get_int_from_buffer         |
|  9.70  | 1.11              | 0.16         | 3         | 53.33          | 226.67          | _map                         |
|  9.70  | 1.27              | 0.16         | 1         | 160.00         | 695.83          | save_bmp_image               |
|  7.27  | 1.40              | 0.12         | 1         | 120.00         | 399.17          | open_bmp_image               |
|  5.15  | 1.48              | 0.09         | 40000000  | 0.00           | 0.00            | _update_file_byte_contents   |
|  3.94  | 1.54              | 0.07         | 10000000  | 0.00           | 0.00            | set_pixel_rgb                |
|  2.42  | 1.58              | 0.04         | 10000000  | 0.00           | 0.00            | get_pixel_rgb                |
|  1.82  | 1.61              | 0.03         | 1         | 30.00          | 550.00          | apply_convolution            |
|  1.21  | 1.64              | 0.02         | 2         | 10.00          | 10.00           | _get_file_byte_number        |

- Big image, 20 layers of blur:

| % Time | Cumulative Seconds | Self Seconds | Calls     | ms/call (self) | ms/call (total) | Name                          |
|--------|--------------------|--------------|-----------|----------------|-----------------|------------------------------|
| 87.02  | 9.59              | 9.59         | 200000000 | 0.00           | 0.00            | apply_convolution_at_pos      |
|  2.99  | 9.92              | 0.33         | 20        | 16.50          | 496.00          | apply_convolution            |
|  2.18  | 10.16             | 0.24         | 3         | 80.00          | 253.33          | _map                         |
|  2.00  | 10.38             | 0.22         | 80000008  | 0.00           | 0.00            | _get_int_from_buffer         |
|  1.72  | 10.57             | 0.19         | 80000000  | 0.00           | 0.00            | _get_pixel                   |
|  1.00  | 10.68             | 0.11         | 40000000  | 0.00           | 0.00            | _update_file_byte_contents   |
|  0.91  | 10.78             | 0.10         | 10000000  | 0.00           | 0.00            | get_pixel_rgb                |
|  0.91  | 10.88             | 0.10         | 1         | 100.00         | 686.67          | save_bmp_image               |
|  0.59  | 10.95             | 0.07         | 10000000  | 0.00           | 0.00            | set_pixel_rgb                |
|  0.36  | 10.98             | 0.04         | 1         | 40.00          | 403.33          | open_bmp_image               |
|  0.18  | 11.01             | 0.02         | 2         | 10.00          | 10.00           | _get_file_byte_number        |
