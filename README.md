...
**_WSL Version_** : Wsman Shell commandLine, version 0.2.1.

**_Architecture_**: x86_64

**_CPU op-mode(s)_**: 32-bit, 64-bit

**_Address sizes_**: 39 bits physical, 48 bits virtual

**_Byte Order_**: Little Endian

**_CPU(s)_**: 8

**_On-line CPU(s) list_**: 0-7

**_Vendor ID_**: GenuineIntel

**_Model name_**: Intel(R) Core(TM) i5-10300H CPU @ 2.50GHz

**_CPU family_**: 6

**_Model_**: 165

**_Thread(s) per core_**: 2

**_Core(s) per socket_**: 4
